...
import { Mail, User, LogIn, Search, Eye, EyeOff, Check } from "lucide-react";
      ...
      <div className="w-full max-w-md pt-20 relative z-10">
        <Card className="shadow-2xl border border-gray-700 bg-gray-800/50 backdrop-blur-sm animate-slide-up">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold text-white animate-fade-in" style={{ animationDelay: '0.2s' }}>Create Account</CardTitle>
            <p className="text-gray-300 mt-2 animate-fade-in" style={{ animationDelay: '0.4s' }}>Start your free trial today</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="grid grid-cols-2 gap-3 animate-slide-up" style={{ animationDelay: '0.6s' }}>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-11 bg-gray-700/50 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 transition-all"
                    required
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2 animate-slide-up" style={{ animationDelay: '1.2s' }}>
              ...
              <div className="flex items-start space-x-2 text-sm animate-fade-in" style={{ animationDelay: '1.4s' }}>
                <button
                  type="button"
                ...
                <label className="text-gray-300 leading-relaxed">
                  I agree to the{" "}
                  <Link to="/terms" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <Button
                ...
                className="w-full h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold hover:scale-105 transition-all animate-slide-up disabled:opacity-50"
        ...
        <p className="text-center text-sm text-gray-400 mt-6 animate-fade-in" style={{ animationDelay: '2.2s' }}>
